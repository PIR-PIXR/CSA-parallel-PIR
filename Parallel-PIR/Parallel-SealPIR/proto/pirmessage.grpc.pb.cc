...
::grpc::Status PIRService::Stub::GetDBInfo(::grpc::ClientContext* context, const ::pir_message::EmptyParam& request, ::pir_message::DBInfo* response) {
  return ::grpc::internal::BlockingUnaryCall< ::pir_message::EmptyParam, ::pir_message::DBInfo, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), rpcmethod_GetDBInfo_, context, request, response);
}

void PIRService::Stub::async::GetDBInfo(::grpc::ClientContext* context, const ::pir_message::EmptyParam* request, ::pir_message::DBInfo* response, std::function<void(::grpc::Status)> f) {
  ::grpc::internal::CallbackUnaryCall< ::pir_message::EmptyParam, ::pir_message::DBInfo, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(stub_->channel_.get(), stub_->rpcmethod_GetDBInfo_, context, request, response, std::move(f));
}

void PIRService::Stub::async::GetDBInfo(::grpc::ClientContext* context, const ::pir_message::EmptyParam* request, ::pir_message::DBInfo* response, ::grpc::ClientUnaryReactor* reactor) {
...
::grpc::ClientAsyncResponseReader< ::pir_message::DBInfo>* PIRService::Stub::PrepareAsyncGetDBInfoRaw(::grpc::ClientContext* context, const ::pir_message::EmptyParam& request, ::grpc::CompletionQueue* cq) {
  return ::grpc::internal::ClientAsyncResponseReaderHelper::Create< ::pir_message::DBInfo, ::pir_message::EmptyParam, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(channel_.get(), cq, rpcmethod_GetDBInfo_, context, request);
}

::grpc::ClientAsyncResponseReader< ::pir_message::DBInfo>* PIRService::Stub::AsyncGetDBInfoRaw(::grpc::ClientContext* context, const ::pir_message::EmptyParam& request, ::grpc::CompletionQueue* cq) {
  auto* result =
...
PIRService::Service::Service() {
  AddMethod(new ::grpc::internal::RpcServiceMethod(
      ...
      new ::grpc::internal::RpcMethodHandler< PIRService::Service, ::pir_message::EmptyParam, ::pir_message::DBInfo, ::grpc::protobuf::MessageLite, ::grpc::protobuf::MessageLite>(
          [](PIRService::Service* service,
             ::grpc::ServerContext* ctx,
             const ::pir_message::EmptyParam* req,
...
::grpc::Status PIRService::Service::GetDBInfo(::grpc::ServerContext* context, const ::pir_message::EmptyParam* request, ::pir_message::DBInfo* response) {
  (void) context;
  (void) request;
  (void) response;
